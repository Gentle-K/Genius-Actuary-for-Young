    ...
    return [
        AssetTemplate(
            ...
            description=text_for_locale(
                ...
                zh_hk="HashKey Chain 官方列出的主網 USDT 合約，適合作為穩定幣收益與流動性基準。",
            ),
            ...
            thesis=text_for_locale(
                ...
                zh_hk="適合作為流動性底倉和低波動收益腿，但需要明確看待脫鈎與贖回信心風險。",
            ),
            fit_summary=text_for_locale(
                ...
                zh_hk="更適合保守或均衡型配置，重點承擔現金管理和出入金緩衝角色。",
            ),
            ...
            status_explanation=text_for_locale(
                ...
                zh_hk="生產可用的鏈上穩定幣基準，合約地址可核驗，可直接作為流動性底倉候選。",
            ),
            truth_level_explanation=text_for_locale(
                ...
                zh_hk="核心事實來自 HashKey 官方網絡文件與鏈上合約地址，可作鏈上交叉驗證。",
            ),
        ...
        AssetTemplate(
            ...
            description=text_for_locale(
                ...
                zh_hk="HashKey Chain 官方列出的主網 Bridged USDC，可作為穩定幣與 MMF 的比較基準。",
            ),
            ...
            thesis=text_for_locale(
                ...
                zh_hk="在披露質量和二級流動性上通常優於一般橋接資產，適合做高流動性配置基線。",
            ),
            fit_summary=text_for_locale(
                locale,
                "适合看重 T+0 可退出和低回撤的人群。",
                "Best for users who prioritize T+0 exits and low drawdown.",
                zh_hk="適合看重 T+0 可退出和低回撤的人群。",
            ),
            evidence_urls=[HASHKEY_TOKEN_CONTRACTS_URL, HASHKEY_NETWORK_INFO_URL],
            primary_source_url=HASHKEY_TOKEN_CONTRACTS_URL,
            onchain_verified=True,
            ...
            status_explanation=text_for_locale(
                ...
                zh_hk="生產可用的鏈上穩定幣基線，適合與 MMF 或 permissioned RWA 做流動性比較。",
            ),
            truth_level_explanation=text_for_locale(
                locale,
        ...
        AssetTemplate(
            ...
            description=text_for_locale(
                ...
                zh_hk="HashKey Chain 生態中披露的 tokenized USD MMF 示例，用於短久期高質量貨幣市場工具配置演示。",
            ),
            ...
            status_explanation=text_for_locale(
                ...
                zh_hk="面向真實 RWA 配置場景的發行人披露型資產，但申購和贖回仍依賴發行方入口。",
            ),
            truth_level_explanation=text_for_locale(
                locale,
                ...
                zh_hk="主要事實來自發行方和生態披露，鏈上只能驗證部分輔助資料。",
            ),
        ...
        AssetTemplate(
            ...
            description=text_for_locale(
                ...
                zh_hk="基於香港受監管白銀 RWA 的演示模板，強調 1:1 實物映射、第三方金庫託管與專業投資者門檻。",
            ),
            ...
            thesis=text_for_locale(
                ...
                zh_hk="適合作為通脹對沖和分散化腿，但收益分布更闊、流動性與託管條款必須單獨審視。",
            ),
            fit_summary=text_for_locale(
                locale,
                ...
                zh_hk="更適合均衡到進取型配置，用於補充與穩定幣/MMF 不同的風險收益來源。",
            ),
            ...
            status_explanation=text_for_locale(
                ...
                zh_hk="生產意圖明確的金屬 RWA 模板，適合做通脹對沖比較，但依舊依賴發行方條款和託管披露。",
            ),
            truth_level_explanation=text_for_locale(
                locale,
                ...
                zh_hk="核心 backing 與託管事實來自發行方披露，尚非全量鏈上可核驗。",
            ),
            action_type=ActionType.SUBSCRIBE,
            action_readiness=ActionReadiness.PARTIAL,
            action_links=_asset_action_links(
        ...
        AssetTemplate(
            ...
            description=text_for_locale(
                ...
                zh_hk="用於 Hackathon 演示的房地產類 RWA 模板，突出申贖摩擦、分紅收益與低流動性的組合特徵。",
            ),
            issuer="Demo SPV",
            ...
            status_explanation=text_for_locale(
                ...
                zh_hk="Hackathon 演示資產，用於展示高摩擦房地產 RWA 情形，不應默認與生產資產同台排名。",
            ),
            truth_level_explanation=text_for_locale(
                locale,
                ...
                zh_hk="該模板用於演示報告結構和風險差異，不代表已驗證的真實發行產品。",
            ),
        ...
        AssetTemplate(
            ...
            description=text_for_locale(
                ...
                zh_hk="HashKey Chain 官方列出的 WBTC 合約，用於給 RWA 方案加入一個高波動鏈上 benchmark。",
            ),
            ...
            status_explanation=text_for_locale(
                ...
                zh_hk="鏈上可核驗的 benchmark，用來衡量機會成本和波動基線，但不會進入正式 RWA 提交流程。",
            ),
            truth_level_explanation=text_for_locale(
                locale,
                ...
                zh_hk="合約本身可鏈上核驗，但該資產在系統裡承擔 benchmark 參考角色。",
            ),
            action_type=ActionType.LEARN_MORE,
            action_readiness=ActionReadiness.UNAVAILABLE,
            action_links=_asset_action_links(
